...
#  error "Packed color format illegal or left unspecified"
    ...
    MxColor(float r, float g, float b, float a) { set(r, g, b, a); }
    MxColor(unsigned int rgba) { as.word = rgba; }
    MxColor(unsigned char r, unsigned char g, unsigned char b, unsigned char a) { as.chan.r=r; as.chan.g=g; as.chan.b=b; as.chan.a=a; }
    ...
    float A() const { return _ptof(as.chan.a); }
};
